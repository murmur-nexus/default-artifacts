#!/usr/bin/env bash
# Package murmur-tool-code-coverage into a platform-tagged .mur.zip artifact.
#
...
ARTIFACT_NAME="murmur-tool-code-coverage"
VERSION="0.1.0"
...
# The default-artifacts workspace root is two levels up from tools/murmur-tool-code-coverage/.
