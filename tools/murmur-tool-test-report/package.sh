#!/usr/bin/env bash
# Package murmur-tool-test-report into a platform-tagged .mur.zip artifact.
#
...
ARTIFACT_NAME="murmur-tool-test-report"
VERSION="0.1.0"
...
# The default-artifacts workspace root is two levels up from tools/murmur-tool-test-report/.
