#!/usr/bin/env bash
# Package murmur-tool-git into a platform-tagged .mur.zip artifact.
#
...
# The default-artifacts workspace root is two levels up from tools/murmur-tool-git/.
