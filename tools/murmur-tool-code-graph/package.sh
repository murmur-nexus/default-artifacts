#!/usr/bin/env bash
# Package murmur-tool-code-graph into a platform-tagged .mur.zip artifact.
#
...
# The default-artifacts workspace root is two levels up from tools/murmur-tool-code-graph/.
